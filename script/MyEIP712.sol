...
contract MyEIP712 is EIP712 {
    ...
    function digest(address owner, uint256 myParam, uint256 deadline) public returns(bytes32){
    ...
    function executeMyFunctionFromSignature(
        ...
        require(signer == owner, "MyData: invalid signature");
        require(signer != address(0), "ECDSA: invalid signature");
        require(block.timestamp < deadline, "Mydata: signed transaction expired");
